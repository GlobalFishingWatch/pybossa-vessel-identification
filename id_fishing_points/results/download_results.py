...
taskrun_url = "http://crowd.globalfishingwatch.org/api/taskrun?project_id=" + str(
    project_id) + "&limit=100&offset="
...
task_url = "http://crowd.globalfishingwatch.org/api/task?project_id=" + str(
    project_id) + "&limit=100&offset="
page = 0
tasks = []
while 1:
