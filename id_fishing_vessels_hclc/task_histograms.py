...
# !gsutil -m cp *  gs://gfw-crowd/histogram/
# and then 
# gsutil -m acl set -R -a public-read gs://gfw-crowd/histogram/


sourcedir = ''
filename = 'map_tasks_20160310_hclc.csv'
outdir = "../data/vessel_histograms_20160304_hclc/"
...
def make_histogram(mmsi, months_2015):
    ...
    for m in months_2015:
        if m != "":
            url = 'http://storage.googleapis.com/gfw-crowd/hclc/'+mmsi+"_2015_"+m+".json"
            print url
            try:
